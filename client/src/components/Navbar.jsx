...
import logo from '../../images/kok.png'
...
const Navbar = () => {
    ...
    return (
        <nav className="w-full flex md:justify-center justify-between item-center p-4">
            <div className="md:flex-[0.5] flex-init justify-center items-center">
            ...
            <ul className="text-white md:flex hidden list-non flex-row justify-between items-center flex-initial">
                ...
                <li className="bg-[#2952e3] py-2 px-7 mx-4 rounded-full cursor-pointer hover:bg-[#2436bd] rounded-full cursor-pointer hover:bg-[#2546bd]">
                    Login
                </li>
            </ul>
